...
public interface SignatureService {
    ...
    Signature addNewSignature(String label, String createdByUser, boolean isActive, String applyToAgenciesId) throws SignatureLabelExistException, SignatureNotFoundException;
    Signature updateSignatureSettings(String currentLabel, String label, String updatedByUser,boolean isActive, String htmlSignature, List<Agency> agencies) throws SignatureLabelExistException, SignatureNotFoundException;
